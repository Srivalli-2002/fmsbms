...
public class PaymentController {
	...
	@PostMapping("/getallpaymentsbyfamilyid")
	public ResponseEntity<List<Payment>> getAllPayments(@RequestBody GetAllPaymentRequest getAllPaymentRequest) throws PaymentServiceNotFoundException, FamilyNotFoundException
	{
		Family family= familyService.getFamilyById(getAllPaymentRequest.getFamilyId());
